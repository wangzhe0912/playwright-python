...
class Frame(AsyncBase):
    ...
    async def is_hidden(self,
                  selector: str,
                  *,
                  strict: typing.Optional[bool] = None) -> bool:
        """Frame.is_hidden
...
class ConsoleMessage(AsyncBase):
    ...
    @property
    def type(self) -> typing.Union[Literal['assert'], Literal['clear'], Literal['count'], Literal['debug'], Literal['dir'], Literal['dirxml'], Literal['endGroup'], Literal['error'], Literal['info'], Literal['log'], Literal['profile'], Literal['profileEnd'], Literal['startGroup'], Literal['startGroupCollapsed'], Literal['table'], Literal['timeEnd'], Literal['trace'], Literal['warning']]:
        """ConsoleMessage.type
...
class Page(AsyncContextManager):
    ...
    async def add_init_script(self,
                        script: typing.Optional[str] = None,
                        *,
                        path: typing.Optional[typing.Union[pathlib.Path, str]] = None) -> None:
...
class BrowserContext(AsyncContextManager):
    ...
    async def clear_cookies(self,
                      *,
                      ...
                      path: typing.Optional[typing.Union[typing.Pattern[str], str]] = None) -> None:
...
class Browser(AsyncContextManager):
    ...
    async def new_context(self,
                    *,
                    ...
                    record_har_url_filter: typing.Optional[typing.Union[typing.Pattern[str], str]] = None,
...
class Locator(AsyncBase):
    ...
    async def aria_snapshot(self,
                      *,
                      timeout: typing.Optional[float] = None,
                      mode: typing.Optional[Literal['expect', 'ai']] = None) -> str:
...
Parameter type mismatch in Locator.aria_snapshot(mode=): documented as Union["ai", "expect", None], code has Union["expect", "ai", None]
